...
public class Project {
    ...
    @Column(name = "project_name", length = 255, unique = true, nullable = false)
    ...
    public Project() {}
    public Project(String projectName, Division division, String projectContent) { this.projectName = projectName; this.division = division; this.projectContent = projectContent; }
