...
public class Career {
    ...
    public Career() {}
    public Career(Profile profile, Project project, LocalDate startTime, LocalDate endTime) {
        this.profile = profile; this.project = project; this.startTime = startTime; this.endTime = endTime;
    }
    ...
    public List<CareerSkill> getCareerSkills() { return careerSkills; }
}
